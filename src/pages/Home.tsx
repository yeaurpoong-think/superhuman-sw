    ...
    <>
      ...
      */}
              ...
              >
                <div className="mx-auto max-w-5xl px-8 md:px-16">
                  ...
                  <p className="mt-6 max-w-sm font-serif text-sm leading-relaxed text-white/75 md:text-base">
                    읽고 지나간 것은 사흘이면 남지 않습니다. 해보고 적어 둔 것만 남습니다.
                  </p>
                </div>
              </div>
            </div>
      ...
      {/*
        ...
        가운데 고랑을 넉넉히 벌려 두 면의 글이 책등 주름에서 멀찍이 떨어지게 한다.
        실제 책도 안쪽 여백이 바깥쪽보다 넓다.
      */}
      <section className="px-6 pt-32 pb-40 md:px-12">
        <div className="mx-auto grid max-w-5xl gap-y-20 md:grid-cols-2 md:gap-x-36">
          <div className="md:pr-2">
            ...
            <p className="mt-8 font-serif text-base leading-loose text-paper md:text-lg">
              AI에 관한 것을 읽고, 직접 만들어 보고, 그 과정에서 알게 된 것을 남깁니다. 결과만이
              아니라 어디서 막혔고 무엇을 다시 했는지까지 적어 둡니다.
            </p>
            <p className="mt-5 font-serif text-base leading-loose text-paper md:text-lg">
              읽기만 한 것은 읽기만 한 칸에 그대로 남습니다. 그래서 이 서고는 제가 무엇을 하지
              않았는지도 같이 보여줍니다.
              {average !== null && (
                <>
                  {' '}
            ...
            <div className="mt-20 border-t border-white/25 pt-12">
              ...
              <p className="mt-7 font-serif text-base leading-loose text-paper md:text-lg">
                앞서간 사람의 정리된 결론만 보고 싶으시다면 이 서고는 맞지 않습니다. 여기 남는
                것은 과정입니다. 무엇을 읽었고, 무엇을 해봤고, 어디서 막혔는지.
              </p>
              <p className="mt-5 font-serif text-base leading-loose text-paper md:text-lg">
                같은 걸 해보려다 같은 데서 막혔던 분이라면, 이 기록이 쓸모가 있을 겁니다.
              </p>
              <p className="mt-7 font-serif text-[15px] leading-loose text-paper">
                새 글은 조용히 쌓입니다. 알림도 구독도 없습니다. 생각나실 때 들러서 그동안 늘어난
                것을 보시면 됩니다.
              </p>
            </div>
          </div>
          ...
          <div className="md:pl-2">
            <dl className="grid gap-9 border-t border-white/25 pt-12">
              {figures.map((f) => (
                <div key={f.label}>
                  ...
                  <p className="mt-3 font-serif text-[13px] leading-relaxed text-paper">{f.note}</p>
                </div>
              ))}
            </dl>
            ...
            {recent.length > 0 && (
              <div className="mt-20 border-t border-white/25 pt-12">
                ...
                <p className="mt-3.5 font-serif text-[15px] leading-loose text-paper">
                  설명보다 제목이 빠릅니다. 최근에 꽂은 것을 그대로 옮겨 둡니다.
                </p>
            ...
            <div className="mt-20 border-t border-white/25 pt-12">
              ...
              <p className="mt-6 font-serif text-[15px] leading-loose text-paper">
                리서치 완료 · 실행 완료 · 콘텐츠 완료 세 칸으로 나뉘어 있습니다.
              </p>
            </div>
            ...
            <div className="mt-20 space-y-5 border-t border-white/25 pt-12 font-serif text-[15px] leading-loose text-paper">
              ...
              <p>
                새 글은 링크 하나에서 시작합니다. 릴스나 글 주소를 던지면 에이전트가 원문을 받아
                정리해 서가에 꽂습니다.
              </p>
              <p>
                분류는 {CATEGORIES.length}개입니다 —{' '}
                {CATEGORIES.map((c) => CATEGORY_LABELS[c]).join(' · ')}. 애매하면 비워 둡니다.
              </p>
              <p>숫자는 이 페이지를 열 때마다 다시 셉니다. 손으로 적어 둔 값이 아닙니다.</p>
              <p>참고 자료는 칸반을 타지 않습니다. 언젠가 쓸 것 같아 꽂아 둔 것들입니다.</p>
              <p>완성된 것만 모이지는 않습니다. 하다가 멈춘 것도 멈춘 자리에 그대로 둡니다.</p>
            </div>
          </div>
        </div>
      </section>
